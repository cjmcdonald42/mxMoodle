...
class block_mxschool_dash_healthcenter extends block_base {
    ...
    public function get_content() {
        ...
        if((get_config('local_mxschool', 'healthtest_enabled')=='1' and has_capability('block/mxschool_dash_healthpass:access_healthtest', context_system::instance()))
          and (get_config('local_mxschool', 'healthpass_enabled')=='1' and has_capability('block/mxschool_dash_healthpass:access_healthpass', context_system::instance()))){
        ...
        if((get_config('local_mxschool', 'healthtest_enabled')=='0' and has_capability('block/mxschool_dash_healthpass:access_healthtest', context_system::instance()))
          and (get_config('local_mxschool', 'healthpass_enabled')=='1' and has_capability('block/mxschool_dash_healthpass:access_healthpass', context_system::instance()))){
              $output = $PAGE->get_renderer('local_mxschool');
  		        $dorm = get_param_faculty_dorm();
                  $filter = $dorm == '' ? "status=Denied" : "dorm={$dorm}";
        ...
        if((get_config('local_mxschool', 'healthtest_enabled')=='1' and has_capability('block/mxschool_dash_healthpass:access_healthtest', context_system::instance()))
          and (get_config('local_mxschool', 'healthpass_enabled')=='0' and has_capability('block/mxschool_dash_healthpass:access_healthpass', context_system::instance()))){
              $output = $PAGE->get_renderer('local_mxschool');
  		        $dorm = get_param_faculty_dorm();
                  $filter = $dorm == '' ? "status=Denied" : "dorm={$dorm}";
                  $today = format_date('Y-m-d');
