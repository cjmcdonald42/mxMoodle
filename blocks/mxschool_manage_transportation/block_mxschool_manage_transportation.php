...
/**
 * Content for Middlesex's Block for the Transportation Manager.
 *
...
class block_mxschool_manage_transportation extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_mxschool_manage_transportation');
    }
    ...
    public function specialization() {
        $this->title = get_string('blockname', 'block_mxschool_manage_transportation');
    }
