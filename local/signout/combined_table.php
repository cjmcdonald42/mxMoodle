    ...
    public function __construct($filter) {
        ...
        $from = array(
            ...
            "{local_signout_on_campus} onc ON onc.id = (
                ...
                WHERE s.userid = oc.userid AND oc.sign_in_time IS NULL AND oc.deleted = 0 AND l.deleted = 0
            ...
            "{local_signout_off_campus} offc ON offc.id = (
                ...
                WHERE s.userid = oc.userid AND oc.sign_in_time IS NULL AND oc.deleted = 0 AND d.deleted = 0
                ORDER BY oc.time_created DESC
                LIMIT 1
            )",
