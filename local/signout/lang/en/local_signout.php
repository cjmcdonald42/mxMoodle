...
$string['on_campus_location_report'] = 'On-Campus Location Report';
$string['on_campus_location_edit'] = 'Edit On-Campus Location Record';
...
$string['on_campus_preferences_config_ipenabled_text'] = 'Check to enable IP validation against {$a->school} for the on-campus subsystem — your current IP is {$a->current}';
$string['on_campus_preferences_config_confirmationenabled_text'] = 'Check to enable confirmation functionality';
...
$string['on_campus_location_report_header_allday'] = 'Available for All Day Students';
...
$string['on_campus_location_edit_location_allday'] = 'Available for All Day Students';
...
$string['off_campus_type_report'] = 'Off-Campus Signout Type Report';
$string['off_campus_type_edit'] = 'Edit Off-Campus Signout Type Record';
...
$string['off_campus_preferences_header_formtext'] = 'Off-Campus Signout Form Instructions and Permissions Warnings';
...
$string['off_campus_preferences_config_permissions_active_text'] = 'Check to enable all off-campus signout types which require student permissions';
$string['off_campus_preferences_config_ipenabled_text'] = 'Check to enable IP validation against {$a->school} for the off-campus subsystem — your current IP is {$a->current}';
...
$string['off_campus_preferences_formtext_ipformerror'] = 'Text to Display in Off-Campus Signout Form When on the Wrong Network';
$string['off_campus_preferences_formtext_ipsigninerror'] = 'Text to Display When a Student Tries to Sign in When on the Wrong Network';
$string['off_campus_preferences_formtext_passengerinstructions'] = 'Instructions Regarding Selecting a Driver';
$string['off_campus_preferences_formtext_bottominstructions'] = 'Instructions at the Bottom of the Off-Campus Signout Form';
$string['off_campus_preferences_formtext_confirmation'] = 'Confirmation for a Passenger a Warning';
$string['off_campus_preferences_formtext_formdrivernopassengers'] = 'Warning for a Student Who May Not Drive Passengers';
$string['off_campus_preferences_formtext_formpassengerparent'] = 'Warning for a Passenger with Permissions to Ride Only with Parent Permission';
$string['off_campus_preferences_formtext_formpassengerspecific'] = 'Warning for a Passenger with Permissions to Ride Only with Specific Drivers';
$string['off_campus_preferences_formtext_formpassengerover21'] = 'Warning for a Passenger with Permissions to Ride Only with Drivers Over 21';
$string['off_campus_preferences_formtext_formrideshareparent'] = 'Warning for a Student with Permissions to Use a Car Service Only with Parent Permission';
$string['off_campus_preferences_formtext_formridesharenotallowed'] = 'Warning for a Student without Permissions to Use a Car Service';
$string['off_campus_preferences_emailtext_emaildrivernopassengers'] = 'Warning for a Student Who May Not Drive Passengers';
$string['off_campus_preferences_emailtext_emailpassengerparent'] = 'Warning for a Passenger with Permissions to Ride Only with Parent Permission';
$string['off_campus_preferences_emailtext_emailpassengerspecific'] = 'Warning for a Passenger with Permissions to Ride Only with Specific Drivers';
$string['off_campus_preferences_emailtext_emailpassengerover21'] = 'Warning for a Passenger with Permissions to Ride Only with Drivers Over 21';
$string['off_campus_preferences_emailtext_emailrideshareparent'] = 'Warning for a Student with Permissions to Use a Car Service Only with Parent Permission';
$string['off_campus_preferences_emailtext_emailridesharenotallowed'] = 'Warning for a Student without Permissions to Use a Car Service';
...
$string['off_campus_type_report_add'] = 'New Type';
$string['off_campus_type_report_header_name'] = 'Name';
$string['off_campus_type_report_header_permissions'] = 'Permissions';
$string['off_campus_type_report_header_grade'] = 'Minimum Grade';
$string['off_campus_type_report_header_boardingstatus'] = 'Boarding Status';
$string['off_campus_type_report_header_weekend'] = 'Weekend Only';
$string['off_campus_type_report_header_enabled'] = 'Enabled';
$string['off_campus_type_report_header_start'] = 'Start Date';
$string['off_campus_type_report_header_end'] = 'End Date';
$string['off_campus_type_report_header_formwarning'] = 'Form Warning';
$string['off_campus_type_report_header_emailwarning'] = 'Email Warning';

// Off-Campus Signout Type Edit.
$string['off_campus_type_edit_header_type'] = 'Type Information';
$string['off_campus_type_edit_type_permissions'] = 'Permissions';
$string['off_campus_type_edit_type_name'] = 'Name';
$string['off_campus_type_edit_type_grade'] = 'Minimum Grade';
$string['off_campus_type_edit_type_grade_9'] = '9';
$string['off_campus_type_edit_type_grade_10'] = '10';
$string['off_campus_type_edit_type_grade_11'] = '11';
$string['off_campus_type_edit_type_grade_12'] = '12';
$string['off_campus_type_edit_type_boardingstatus'] = 'Boarding Status';
$string['off_campus_type_edit_type_boardingstatus_Boarder'] = 'Boarder';
$string['off_campus_type_edit_type_boardingstatus_Day'] = 'Day';
$string['off_campus_type_edit_type_boardingstatus_All'] = 'All';
$string['off_campus_type_edit_type_weekend'] = 'Weekend Only';
$string['off_campus_type_edit_type_enabled'] = 'Enabled';
$string['off_campus_type_edit_type_start'] = 'Start Date';
$string['off_campus_type_edit_type_end'] = 'End Date';
$string['off_campus_type_edit_type_formwarning'] = 'Form Warning';
$string['off_campus_type_edit_type_emailwarning'] = 'Email Warning';

// Off-Campus Signout Type Notifications.
$string['off_campus_type_create_success'] = 'Off-Campus Signout Type Record Created Successfully';
$string['off_campus_type_update_success'] = 'Off-Campus Signout Type Record Updated Successfully';
$string['off_campus_type_delete_success'] = 'Off-Campus Signout Type Record Deleted Successfully';
$string['off_campus_type_delete_failure'] = 'Off-Campus Signout Type Record Not Found for Deletion';
