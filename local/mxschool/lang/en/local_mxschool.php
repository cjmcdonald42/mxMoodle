...
$string['esignout_preferences_config_tripwindow'] = 'Window for a Driver to be Available for Selection';
...
$string['rooming_preferences_notifications_tags'] = 'Available Tags for Unsubmitted Reminder Email';
