...
$string['deans_permission:preferences:notifystudent_email'] = 'Deans\' Permission Form Notify Student Email Notification';
$string['deans_permission:preferences:notifystudent_email:note'] = 'If the message to student is sent, this email will go to the student and the advisor of the student';
$string['deans_permission:preferences:approved_email:info'] = 'Note:';
$string['deans_permission:preferences:notifystudent_email:info'] = 'Note:';
...
$string['deans_permission:preferences:notifystudent_email:notifystudent_tags'] = 'Available tags for deans\' permission form notify student email';
$string['deans_permission:preferences:approved_email:approved_subject'] = 'Deans\' permission form approved email subject';
$string['deans_permission:preferences:notifystudent_email:notifystudent_subject'] = 'Deans\' permission form notify student email subject';
$string['deans_permission:preferences:approved_email:approved_body'] = 'Deans\' permission form approved email body';
$string['deans_permission:preferences:notifystudent_email:notifystudent_body'] = 'Deans\' permission form notify student email body';
