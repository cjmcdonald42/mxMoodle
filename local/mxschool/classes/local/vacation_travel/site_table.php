...
class site_table extends \local_mxschool\table {
    ...
    protected function col_departureenabled($values) {
        ...
        $renderable = new checkbox($values->id, 'local_mxschool_vt_site', 'enabled_departure', $values->departureenabled);
    ...
    protected function col_returnenabled($values) {
        global $PAGE;
        $output = $PAGE->get_renderer('local_mxschool');
        $renderable = new checkbox($values->id, 'local_mxschool_vt_site', 'enabled_return', $values->returnenabled);
        return $output->render($renderable);
    }
