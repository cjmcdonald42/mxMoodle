...
- Introduction of formal subpackage abstraction to greatly simplify page setup and package organization, especially with SubPlugins. See the [updated plugin structure documentation](/docs/PLUGIN_STRUCTURE.md) for more information.
