...
$url = '/local/mxschool/esignout/vehicle_edit.php';
$title = get_string('esignout_vehicle_edit', 'local_mxschool');
...
if ($form->is_cancelled()) {
    ...
    logged_redirect(
        $form->get_redirect(), $data->id ? get_string('esignout_vehicle_edit_success', 'local_mxschool')
        : get_string('esignout_vehicle_create_success', 'local_mxschool'), $data->id ? 'update' : 'create'
    );
}
