...
$buttons = array(
    new local_mxschool\output\redirect_button(
        get_string('healthtest:audit_report:appointment', 'local_mxschool'),
            new moodle_url('/local/mxschool/healthtest/appointment_form.php')
    ),
    new local_mxschool\output\redirect_button(
        get_string('healthtest:audit_report:block_report', 'local_mxschool'),
            new moodle_url('/local/mxschool/healthtest/block_report.php')
    ),
    new local_mxschool\output\redirect_button(
        get_string('healthtest:audit_report:test_report', 'local_mxschool'),
            new moodle_url('/local/mxschool/healthtest/test_report.php')
    )
);
