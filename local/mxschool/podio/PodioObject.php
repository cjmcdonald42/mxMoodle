<?php
require_once('PodioByLine.php');
require_once('PodioVia.php');
require_once('PodioItemRevision.php');
require_once('PodioItemFieldCollection.php');
require_once('PodioApp.php');
require_once('PodioReference.php');
require_once('PodioReminder.php');
require_once('PodioRecurrence.php');
require_once('PodioLinkedAccountData.php');
class PodioObject {
