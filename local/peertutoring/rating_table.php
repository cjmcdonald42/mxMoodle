...
/**
 * Effectiveness rating table for Middlesex School's Peer Tutoring Subplugin.
 *
...
class rating_table extends local_mxschool_table {
    ...
    public function __construct() {
        ...
        foreach ($columns as $column) {
            $headers[] = get_string("rating_report_header_{$column}", 'local_peertutoring');
        }
        $columns[] = 'actions';
